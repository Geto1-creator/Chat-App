  ...
  return (
    <div className={styles.overallContainer}>
      {messages.map((message) => {
        console.log(message)
        return (
          <div key={message.id} className={ message.senderId === user.user_id ? styles.ownerContainer : styles.Container}>
            ...
            <div className={styles.secondLine}>
              ...
              ></img>
              <div  className={ message.senderId === user.user_id ? styles.ownerMessageBorder : styles.messageBorder}>
